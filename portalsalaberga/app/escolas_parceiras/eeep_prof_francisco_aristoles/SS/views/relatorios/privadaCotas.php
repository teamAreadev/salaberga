...
function privadaCotas($curso)
{
    ...
    $stmtSelect = $conexao->prepare("
        ...
        FROM candidato 
        INNER JOIN nota ON nota.candidato_id_candidato = candidato.id_candidato AND candidato.publica = 0 and (candidato.bairro = 1 OR candidato.pcd = 1) AND candidato.id_curso1_fk = :curso
