...
function edificacoesPub() {
    showModal('Redes', 'Escola Pública');
}

function edificacoesPriv() {
    showModal('Redes', 'Escola Privada');
}
...
function createEdificacoesForm(schoolType, subjects) {
    return createForm('Redes', schoolType, subjects);
}
...
// Função específica para o formulário de Redes
...
<form id="EdificacoesForm"  action="../controllers/controller.php" method="POST" class="w-auto bg-[--ceara-white] rounded-xl shadow-md">
    ...
    <div class="bg-[#4a4a4a] p-3 rounded-t-xl">
        <h2 class="text-3xl font-bold text-[--ceara-white] text-center mb-2">Formulário de Redes</h2>
    </div>
    ...
    <input type="text" name="nasc" maxlength="10" placeholder="DD/MM/AAAA" 
        ...
        <div class="flex flex-col md:col-span-1">
            <input type="text" name="curso" value="Redes" class="px-3 py-1.5 bg-gray-50 border border-[--gray-600] rounded-md w-full" disabled>
            <input type="hidden" name="curso" value="Redes">
        </div>
