...
<form id="InformaticaForm" action="../controllers/controller.php" method="POST" class="w-auto bg-[--ceara-white] rounded-xl shadow-md">
    ...
    <input type="text" name="nasc" maxlength="10" placeholder="DD/MM/AAAA" 
        ...
        <div class="flex flex-col md:col-span-1">
            <input type="text" name="curso" value="Química" class="px-3 py-1.5 bg-gray-50 border border-[--gray-600] rounded-md w-full" disabled>
            <input type="hidden" name="curso" value="Química">
        </div>
...
// Função específica para o formulário de Secretariado
...
// Função específica para o formulário de Têxtil
