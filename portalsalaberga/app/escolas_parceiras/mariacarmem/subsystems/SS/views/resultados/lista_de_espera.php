...
function lista_de_espera($curso)
{
    ...
    switch ($curso) {
        ...
        case 1:
            $nome_curso = 'Dev de Sistemas';
            break;
        case 2:
            $nome_curso = 'Química';
            break;
        case 3:
            $nome_curso = 'Secretariado';
            break;
        case 4:
            $nome_curso = 'Têxtil';
            break;
    ...
    nota.matematica DESC LIMIT 300 OFFSET 24;
    ");
    ...
    candidato.data_nascimento DESC,
    nota.l_portuguesa DESC,
    nota.matematica DESC LIMIT 300 OFFSET 10;
    ");
    ...
    candidato.data_nascimento DESC,
    nota.l_portuguesa DESC,
    nota.matematica DESC LIMIT 300 OFFSET 6;
    ");
    ...
    candidato.data_nascimento DESC,
    nota.l_portuguesa DESC,
    nota.matematica DESC LIMIT 300 OFFSET 3;
    ");
