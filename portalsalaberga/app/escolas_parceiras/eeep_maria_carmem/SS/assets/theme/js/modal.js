...
function desenvolvimentoSistemasPub() {
    showModal('Desenvolvimento de Sistemas', 'Escola Pública');
}

function desenvolvimentoSistemasPriv() {
    showModal('Desenvolvimento de Sistemas', 'Escola Privada');
}

function quimicaPub() {
    showModal('Química', 'Escola Pública');
}

function quimicaPriv() {
    showModal('Química', 'Escola Privada');
}

function secretariadoPub() {
    showModal('Secretariado', 'Escola Pública');
}

function secretariadoPriv() {
    showModal('Secretariado', 'Escola Privada');
}

function textilPub() {
    showModal('Têxtil', 'Escola Pública');
}

function textilPriv() {
    showModal('Têxtil', 'Escola Privada');
}
...
function createModalContent(courseName, schoolType) {
    ...
    switch (courseName) {
        case 'Desenvolvimento de Sistemas':
            return createDesenvolvimentodeSistemasForm(schoolType, subjects);
        case 'Química':
            return createQuimicaForm(schoolType, subjects);
        case 'Secretariado':
            return createSecretariadoForm(schoolType, subjects);
        case 'Têxtil':
            return createTextilForm(schoolType, subjects);
        default:
            return '';
    }
}

function createDesenvolvimentodeSistemasForm(schoolType, subjects) {
    return createForm('Desenvolvimento de Sistemas', schoolType, subjects);
}

function createQuimicaForm(schoolType, subjects) {
    return createForm('Química', schoolType, subjects);
}

function createSecretariadoForm(schoolType, subjects) {
    return createForm('Secretariado', schoolType, subjects);
}

function createTextilForm(schoolType, subjects) {
    return createForm('Têxtil', schoolType, subjects);
}
...
function createModalContent(courseName, schoolType) {
    switch (courseName) {
        case 'Desenvolvimento de Sistemas':
            return createDesenvolvimentodeSistemasForm(schoolType);
        case 'Química':
            return createQuimicaForm(schoolType);
        case 'Secretariado':
            return createSecretariadoForm(schoolType);
        case 'Têxtil':
            return createTextilForm(schoolType);
        default:
            return '';
    }
}
...
function createDesenvolvimentodeSistemasForm(schoolType) {
    return `
    <form id="DesenvolvimentodeSistemasForm" action="../controllers/controller.php" method="POST" class="w-auto bg-[--ceara-white] rounded-xl shadow-md">
        <!-- Cabeçalho -->
        <div class="bg-[#DC2626] p-3 rounded-t-xl">
            <h2 class="text-3xl font-bold text-[--ceara-white] text-center mb-2">Formulário de Desenvolvimento de Sistemas</h2>
        </div>
    ...
    <input type="text" name="nasc" maxlength="10" placeholder="DD/MM/AAAA" 
           ...
           oninput="maskNascimento(this)" required>
            ...
            <div class="flex flex-col md:col-span-1">
                <input type="text" name="curso" value="Desenvolvimento de Sistemas" class="px-3 py-1.5 bg-gray-50 border border-[--gray-600] rounded-md w-full" disabled>
                <input type="hidden" name="curso" value="Desenvolvimento de Sistemas">
            </div>
    ...
    <div class="flex justify-center space-x-4 mt-4 pt-3 border-t px-4 pb-4">
        <button type="button" onclick="closeModalAndRedirect('DesenvolvimentodeSistemasForm', 'inicio.php');" 
...
<div class="mb-6">
    <div class="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 lg:grid-cols-5 xl:grid-cols-10 gap-2 md:gap-3">
        <div>
            <h3 class="text-lg md:text-xl font-semibold text-[#DC2626] mb-4 pb-1 border-b">Média Geral</h3>
        </div>
        <div>
        ...
        <div>
            <input type="text" name="h9_4" placeholder="HISTÓRIA" class="w-full mt-1 px-2 py-1.5 border border-[--gray-600] rounded-md text-center focus:ring-1 focus:ring-[#DC2626] text-sm" oninput="maskNota(this)" onkeypress="Event()">
        </div>
        <div>
            <input type="text" name="g9_4" placeholder="GEOGRAFIA" class="w-full mt-1 px-2 py-1.5 border border-[--gray-600] rounded-md text-center focus:ring-1 focus:ring-[#DC2626] text-sm" oninput="maskNota(this)" onkeypress="Event()">
        </div>
        <div>
            <input type="text" name="c9_4" placeholder="CIÊNCIAS" class="w-full mt-1 px-2 py-1.5 border border-[--gray-600] rounded-md text-center focus:ring-1 focus:ring-[#DC2626] text-sm" oninput="maskNota(this)" onkeypress="Event()">
        </div>
        <div>
        ...
        <div>
            <input type="text" name="r9_4" placeholder="RELIGIÃO" class="w-full mt-1 px-2 py-1.5 border border-[--gray-600] rounded-md text-center focus:ring-1 focus:ring-[#DC2626] text-sm" oninput="maskNota(this)" onkeypress="Event()">
        </div>
    </div>
</div>
    <div class="flex justify-center space-x-4 mt-4 pt-3 border-t px-4 pb-4">
...
function createQuimicaForm(schoolType) {
    return `
<form id="QuimicaForm" action="../controllers/controller.php" method="POST" class="w-auto bg-[--ceara-white] rounded-xl shadow-md">
    <!-- Cabeçalho -->
    <div class="bg-[#4a90e2] p-3 rounded-t-xl">
        <h2 class="text-3xl font-bold text-[--ceara-white] text-center mb-2">Formulário de Química</h2>
    </div>
    ...
    <input type="text" name="nasc" maxlength="10" placeholder="DD/MM/AAAA" 
        ...
        <div class="flex flex-col md:col-span-1">
            <input type="text" name="curso" value="Quimíca" class="px-3 py-1.5 bg-gray-50 border border-[--gray-600] rounded-md w-full" disabled>
            <input type="hidden" name="curso" value="Quimíca">
        </div>
...
<div class="flex justify-center space-x-4 mt-4 pt-3 border-t px-4 pb-4">
        <button type="button" onclick="closeModalAndRedirect('QuimicaForm', 'inicio.php');" 
...
function createSecretariadoForm(schoolType) {
    return `
<form id="SecretariadoForm" action="../controllers/controller.php" method="POST" class="w-auto bg-[--ceara-white] rounded-xl shadow-md">
    <!-- Cabeçalho -->
    <div class="bg-[#008000] p-3 rounded-t-xl">
        <h2 class="text-3xl font-bold text-[--ceara-white] text-center mb-2">Formulário de Secretariado</h2>
    </div>
    ...
    <input type="text" name="nasc" maxlength="10" placeholder="DD/MM/AAAA" 
        ...
        <div class="flex flex-col md:col-span-1">
            <input type="text" name="curso" value="Secretariado" class="px-3 py-1.5 bg-gray-50 border border-[--gray-600] rounded-md w-full" disabled>
            <input type="hidden" name="curso" value="Secretariado">
        </div>
 ...
 <div class="flex justify-center space-x-4 mt-4 pt-3 border-t px-4 pb-4">
        <button type="button" onclick="closeModalAndRedirect('SecretariadoForm', 'inicio.php');" 
...
<!-- Modal para Nono Ano -->
    ...
    <div>
        <input type="text" name="h9_1" placeholder="HISTÓRIA" class="w-full mt-1 px-2 py-1.5 border border-[--gray-600] rounded-md text-center focus:ring-1 focus:ring-[#008000] text-sm" required oninput="maskNota(this)" onkeypress="Event()">
    </div>
    <div>
        <input type="text" name="g9_1" placeholder="GEOGRAFIA" class="w-full mt-1 px-2 py-1.5 border border-[--gray-600] rounded-md text-center focus:ring-1 focus:ring-[#008000] text-sm" required oninput="maskNota(this)" onkeypress="Event()">
    </div>
    <div>
        <input type="text" name="c9_1" placeholder="CIÊNCIAS" class="w-full mt-1 px-2 py-1.5 border border-[--gray-600] rounded-md text-center focus:ring-1 focus:ring-[#008000] text-sm" required oninput="maskNota(this)" onkeypress="Event()">
    </div>
    <div>
...
<div class="mb-6">
    <div class="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 lg:grid-cols-5 xl:grid-cols-10 gap-2 md:gap-3">
        ...
        <div>
            <input type="text" name="h9_2" placeholder="HISTÓRIA" class="w-full mt-1 px-2 py-1.5 border border-[--gray-600] rounded-md text-center focus:ring-1 focus:ring-[#008000] text-sm" required oninput="maskNota(this)" onkeypress="Event()">
        </div>
        <div>
            <input type="text" name="g9_2" placeholder="GEOGRAFIA" class="w-full mt-1 px-2 py-1.5 border border-[--gray-600] rounded-md text-center focus:ring-1 focus:ring-[#008000] text-sm" required oninput="maskNota(this)" onkeypress="Event()">
        </div>
        <div>
            <input type="text" name="c9_2" placeholder="CIÊNCIAS" class="w-full mt-1 px-2 py-1.5 border border-[--gray-600] rounded-md text-center focus:ring-1 focus:ring-[#008000] text-sm" required oninput="maskNota(this)" onkeypress="Event()">
        </div>
        <div>
...
<div class="mb-6">
    <div class="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 lg:grid-cols-5 xl:grid-cols-10 gap-2 md:gap-3">
        ...
        <div>
            <input type="text" name="h9_3" placeholder="HISTÓRIA" class="w-full mt-1 px-2 py-1.5 border border-[--gray-600] rounded-md text-center focus:ring-1 focus:ring-[#008000] text-sm" required oninput="maskNota(this)" onkeypress="Event()">
        </div>
        <div>
            <input type="text" name="g9_3" placeholder="GEOGRAFIA" class="w-full mt-1 px-2 py-1.5 border border-[--gray-600] rounded-md text-center focus:ring-1 focus:ring-[#008000] text-sm" required oninput="maskNota(this)" onkeypress="Event()">
        </div>
        <div>
            <input type="text" name="c9_3" placeholder="CIÊNCIAS" class="w-full mt-1 px-2 py-1.5 border border-[--gray-600] rounded-md text-center focus:ring-1 focus:ring-[#008000] text-sm" required oninput="maskNota(this)" onkeypress="Event()">
        </div>
        <div>
...
function createTextilForm(schoolType) {
    return `
<form id="TêxtilForm"  action="../controllers/controller.php" method="POST" class="w-auto bg-[--ceara-white] rounded-xl shadow-md">
    <!-- Cabeçalho -->
    <div class="bg-[#4a4a4a] p-3 rounded-t-xl">
        <h2 class="text-3xl font-bold text-[--ceara-white] text-center mb-2">Formulário de Têxtil</h2>
    </div>
    ...
    <input type="text" name="nasc" maxlength="10" placeholder="DD/MM/AAAA" 
        ...
        <div class="flex flex-col md:col-span-1">
            <input type="text" name="curso" value="Têxtil" class="px-3 py-1.5 bg-gray-50 border border-[--gray-600] rounded-md w-full" disabled>
            <input type="hidden" name="curso" value="Têxtil">
        </div>
...
<div class="flex justify-center space-x-4 mt-4 pt-3 border-t px-4 pb-4">
        <button type="button" onclick="closeModalAndRedirect('TêxtilForm', 'inicio.php');" 
...
window.desenvolvimentoSistemasPub = desenvolvimentoSistemasPub;
window.desenvolvimentoSistemasPriv = desenvolvimentoSistemasPriv;
window.quimicaPub = quimicaPub;
window.quimicaPriv = quimicaPriv;
window.secretariadoPub = secretariadoPub;
window.secretariadoPriv = secretariadoPriv;
window.informaticaPub = textilPub;
window.informaticaPriv = textilPriv;
