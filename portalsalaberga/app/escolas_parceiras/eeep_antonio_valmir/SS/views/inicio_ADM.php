...
<body>
    ...
    <main class="max-w-[1400px] mx-auto px-4 sm:px-6 lg:px-8 py-12" style="position:relative; margin-top: 100px">
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 lg:gap-8">
            ...
            <div class="bg-white rounded-3xl shadow-2xl p-6 lg:p-8 transform transition-all duration-300 hover:scale-105 hover:shadow-2xl border border-gray-100">
                <div class="flex flex-col h-full justify-between">
                    <h3 class="text-2xl lg:text-3xl text-gray-800 mb-6 lg:mb-8 text-center" style="font-family: 'Montserrat', sans-serif; font-weight: 700; letter-spacing: -0.5px;">Eletromecânica</h3>
                    <div class="space-y-4">
                        <button onclick="eletromecanicaPub()"
                            class="w-full py-2.5 lg:py-3 px-4 lg:px-6 bg-gradient-to-r from-[#008000] to-[#008000] text-white rounded-full text-base lg:text-lg transition-all duration-300 hover:from-[#008000] hover:to-[#008000] hover:shadow-lg focus:outline-none focus:ring-4 focus:ring-blue-200"
                            style="font-family: 'Source Sans Pro', sans-serif; font-weight: 600; letter-spacing: 0.2px;">
                            Escola Pública
                        </button>
                        <button onclick="eletromecanicaPriv()"
                            class="w-full py-2.5 lg:py-3 px-4 lg:px-6 bg-gradient-to-r from-[#008000] to-[#008000] text-white rounded-full text-base lg:text-lg transition-all duration-300 hover:from-[#008000] hover:to-[#008000] hover:shadow-lg focus:outline-none focus:ring-4 focus:ring-blue-200"
                            style="font-family: 'Source Sans Pro', sans-serif; font-weight: 600; letter-spacing: 0.2px;">
                            Escola Privada
                        </button>
            ...
            <div class="bg-white rounded-3xl shadow-2xl p-6 lg:p-8 transform transition-all duration-300 hover:scale-105 hover:shadow-2xl border border-gray-100">
                <div class="flex flex-col h-full justify-between">
                    ...
                    <div class="space-y-4">
                        ...
                        class="w-full py-2.5 lg:py-3 px-4 lg:px-6 bg-gradient-to-r from-blue-500 to-blue-700 text-white rounded-full text-base lg:text-lg transition-all duration-300 hover:from-blue-600 hover:to-blue-800 hover:shadow-lg focus:outline-none focus:ring-4 focus:ring-blue-300"
                        style="font-family: 'Source Sans Pro', sans-serif; font-weight: 600; letter-spacing: 0.2px;">
                        Escola Pública
                    </button>
            ...
            <div class="bg-white rounded-3xl shadow-2xl p-6 lg:p-8 transform transition-all duration-300 hover:scale-105 hover:shadow-2xl border border-gray-100">
                <div class="flex flex-col h-full justify-between">
                    ...
                    <div class="space-y-4">
                        <button onclick="informaticaPubPub()"
