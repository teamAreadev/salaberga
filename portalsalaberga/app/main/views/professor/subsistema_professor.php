    ...
    <main>
        <div class="app-grid">
            ...
            <a href="/calendario-academico" class="app-icon">
                <div class="icon"><img src="https://i.postimg.cc/fLFcgPD2/video-tutorial.png"
                        alt="Calendário Acadêmico"></div>
            ...
            <a href="/atividades" class="app-icon">
                <div class="icon"><img src="https://i.postimg.cc/V63tFbW2/gerenciamento-de-equipe.png" alt="Atividades">
                </div>
