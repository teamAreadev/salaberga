    ...
    M               M
        ...
        <body>
                        ...
                        <div class="flex items-center space-x-4">
                            ...
                            <div class="relative group">
                                <a href="/perfil" class="flex items-center space-x-2 focus:outline-none group">
                                    <img src="" alt="Perfil" class="h-8 w-8 rounded-full bg-white p-1 border-2 border-transparent group-hover:border-[#FFA500] transition-colors duration-300">
                                    <span class="hidden sm:inline group-hover:text-[#FFA500] transition-colors duration-300">Meu Perfil</span>
                                    <svg class="h-4 w-4 fill-current group-hover:text-[#FFA500] transition-colors duration-300" viewBox="0 0 20 20">
                                        <path d="M5.293 7.293a1 1 0 011.414 0L10 10.586l3.293-3.293a1 1 0 111.414 1.414l-4 4a1 1 0 01-1.414 0l-4-4a1 1 0 010-1.414z" />
                                    </svg>
                                </a>
                                <div class="absolute right-0 mt-2 w-48 bg-white rounded-md shadow-lg py-1 hidden group-hover:block">
                                    <a href="/configuracoes" class="block px-4 py-2 text-sm text-gray-700 hover:bg-[#FFA500] hover:text-white">Configurações</a>
                                    <a href="/sair" class="block px-4 py-2 text-sm text-gray-700 hover:bg-[#FFA500] hover:text-white">Sair</a>
                                </div>
                            </div>
                            <button class="md:hidden text-white focus:outline-none hover:text-[#FFA500] transition-colors duration-300">
            ...
            <main>
                <div class="app-grid">
                    <a href="./index_professor.php" class="app-icon">
                        <div class="icon"><img src="img\Design sem nome.svg" alt="Portal"></div>
                        <span class="app-name">Portal Stgm</span>
                    </a>
                    <a href="/suporte" class="app-icon">
                        <div class="icon"><img src="https://i.postimg.cc/cHVHnLbG/apoio-suporte.png" alt="Suporte"></div>
                        <span class="app-name">Suporte técnico</span>
                    </a>
                    <a href="/horario" class="app-icon">
                        <div class="icon"><img src="https://i.postimg.cc/kGpWtbRV/relogio.png" alt="Horário"></div>
                        <span class="app-name">Horário de Aulas</span>
                    </a>
                    <a href="/turmas" class="app-icon">
                        <div class="icon"><img src="https://i.postimg.cc/sf6YLtHV/matricular.png" alt="Turmas"></div>
                        <span class="app-name">Gerenciar Turmas</span>
                    </a>
                    <a href="/desempenho" class="app-icon">
                        <div class="icon"><img src="https://i.postimg.cc/9FDdHJsy/vitoria.png" alt="Desempenho"></div>
                        <span class="app-name">Desempenho da Turma</span>
                    </a>
                    <a href="/notas" class="app-icon">
                        <div class="icon"><img src="https://i.postimg.cc/jSNyLCx5/nota.png" alt="Notas"></div>
                        <span class="app-name">Lançar Notas</span>
                    </a>
                    <a href="/frequencia" class="app-icon">
                        <div class="icon"><img src="https://i.postimg.cc/LX4PCTzY/desqualificado.png" alt="Frequência"></div>
                        <span class="app-name">Registrar Frequência</span>
                    </a>
                    <a href="/historico" class="app-icon">
                        <div class="icon"><img src="https://i.postimg.cc/d3HjmfpV/conto-1.png" alt="Histórico"></div>
                        <span class="app-name">Histórico de Turmas</span>
                    </a>
                    <a href="/plano-aula" class="app-icon">
                        <div class="icon"><img src="https://i.postimg.cc/3rcG12WN/fluxograma.png" alt="Plano de Aula"></div>
                        <span class="app-name">Plano de Aula</span>
                    </a>
                    <a href="/material-didatico" class="app-icon">
                        <div class="icon"><img src="https://i.postimg.cc/tgkZxxLX/tarefa.png" alt="Material Didático"></div>
                        <span class="app-name">Material Didático</span>
                    </a>
                    ...
                    <a href="/calendario-academico" class="app-icon">
                        <div class="icon"><img src="https://i.postimg.cc/fLFcgPD2/video-tutorial.png" alt="Calendário Acadêmico"></div>
                        <span class="app-name">Calendário Acadêmico</span>
                    </a>
                    <a href="/diarios" class="app-icon">
                        <div class="icon"><img src="https://i.postimg.cc/yN806KNp/escola.png" alt="Diários"></div>
                        <span class="app-name">Diários de Classe</span>
                    </a>
                    <a href="/atividades" class="app-icon">
                        <div class="icon"><img src="https://i.postimg.cc/V63tFbW2/gerenciamento-de-equipe.png" alt="Atividades"></div>
                        <span class="app-name">Criar Atividades</span>
                    </a>
                    <a href="/relatorios" class="app-icon">
                        <div class="icon"><img src="https://i.postimg.cc/sfh7gwVz/permissoes.png" alt="Relatórios"></div>
