...
.logo-container {
  ...
  align-items: center;
        ...
        .enfermagem .button { background-color: #dc2626; }
        .informatica .button { background-color: #2563eb; }
        .administracao .button { background-color: #16a34a; }
        .edificacoes .button { background-color: #d97706; }
        ...
        <div class="flex justify-between items-center h-16">
            ...
            <div class="flex-shrink-0 flex items-center">
                <img 
                    ...
                    alt="Logo SEEPS" 
                    class="h-8 w-auto sm:h-10 transition-transform duration-300 hover:scale-105 logo-img w-32 h-auto"
                    class="logo-img w-32 h-auto"
                >
            </div>
