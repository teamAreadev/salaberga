...
function createEnfermagemForm(schoolType) {
  ...
  <div class="grid grid-cols-1 md:grid-cols-6 gap-6 mb-8">
    <!-- Nome Completo: Full width across all columns -->
    <div class="flex flex-col md:col-span-6">
        <input type="text" name="nome" class="px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-400 w-full" style =  " text-align: center;" placeholder="Nome Completo" required>
    </div>

    <!-- Data de Nascimento: Small width on medium screens and larger -->
    <div class="flex flex-col md:col-span-1">
        <input type="date" name="nasc" class="px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-400 w-full" required>
    </div>

    <!-- Curso: Small width on medium screens and larger -->
    <div class="flex flex-col md:col-span-1">
        <input type="text" name="curso" value="Enfermagem" class="px-4 py-2 bg-gray-50 border border-gray-300 rounded-lg w-full" disabled>
        <input type="hidden" name="curso" value="Enfermagem">
    </div>

    <!-- Tipo de Escola: Small width on medium screens and larger -->
    <div class="flex flex-col md:col-span-1">
        <input type="text" name="${schoolType}" value="${schoolType}" class="px-4 py-2 bg-gray-50 border border-gray-300 rounded-lg w-full" disabled>
        <input type="hidden" name="publica" value="${schoolType}">
    </div>

    <!-- Bairro: Small width on medium screens and larger, select dropdown -->
    <div class="flex flex-col md:col-span-2">
        <select name="bairro" class="px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-400 w-full" required>
    ...
    <!-- PCD Checkbox with Inline Label -->
    <div class="flex items-center md:col-span-1">
        <label for="pcd" class="text-sm font-medium text-gray-700 mr-2">PCD</label>
        <input type="checkbox" id="pcd" name="pcd" value="1" class="w-5 h-5 text-blue-600 border border-gray-300 rounded focus:ring-2 focus:ring-blue-400">
    </div>
</div>
...
<form id="EdificaçoesForm" action="../controllers/controller.php" method="POST" class="w-auto bg-[--ceara-white] rounded-xl shadow-md">
    <div class="bg-[#008C45] p-4 rounded-t-xl">
        <h2 class="text-2xl font-bold text-[--ceara-white] text-center mb-6">Formulário de Edificações</h2>
    </div>

    <!-- Informações Pessoais -->
    <div class="grid grid-cols-1 md:grid-cols-6 gap-6 mb-8 p-6">
        <div class="flex flex-col md:col-span-6">
            <input type="text" name="nome" class="px-4 py-2 border border-[--gray-600] rounded-lg focus:ring-2 focus:ring-[#008C45] w-full transition-all duration-[--transition-duration]" style="text-align: center;" placeholder="Nome Completo" required>
        </div>

        <div class="flex flex-col md:col-span-1">
            <input type="date" name="nasc" class="px-4 py-2 border border-[--gray-600] rounded-lg focus:ring-2 focus:ring-[#008C45] w-full transition-all duration-[--transition-duration]" required>
        </div>

        <div class="flex flex-col md:col-span-1">
            <input type="text" name="curso" value="Enfermagem" class="px-4 py-2 bg-gray-50 border border-[--gray-600] rounded-lg w-full" disabled>
            <input type="hidden" name="curso" value="Enfermagem">
        </div>

        <div class="flex flex-col md:col-span-1">
            <input type="text" name="${schoolType}" value="${schoolType}" class="px-4 py-2 bg-gray-50 border border-[--gray-600] rounded-lg w-full" disabled>
            <input type="hidden" name="publica" value="${schoolType}">
        </div>

        <div class="flex flex-col md:col-span-2">
            <select name="bairro" class="px-4 py-2 border border-[--gray-600] rounded-lg focus:ring-2 focus:ring-[#008C45] w-full transition-all duration-[--transition-duration]" required>
                <option value="">Selecione um bairro</option>
                <option value="Outra Banda">Outra Banda</option>
                <option value="Outros Bairros">Outros Bairros</option>
            </select>
        ...
        <div class="flex items-center md:col-span-1">
            <label for="pcd" class="text-sm font-medium text-[--gray-600] mr-2">PCD</label>
            <input type="checkbox" id="pcd" name="pcd" value="1" class="w-5 h-5 text-[#008C45] border border-[--gray-600] rounded focus:ring-2 focus:ring-[#008C45] transition-all duration-[--transition-duration]">
        </div>
    </div>
...
<div class="mt-8">
    <div class="space-y-6">
        <!-- 6º Ano -->
        <div class="bg-white p-6 rounded-xl shadow-[--shadow-sm] hover:shadow-[--shadow-md] transition-all duration-[--transition-duration]">
            <h3 class="text-lg font-semibold text-[#008C45] mb-4 pb-2 border-b border-[--gray-600]">6º Ano</h3>
            <div class="grid grid-cols-10 gap-4">
                <div class="col-span-1"></div>
                <div class="col-span-8 grid grid-cols-8 gap-4">
                    <div>
                        <label class="text-sm text-[--gray-600] font-medium">Português</label>
                        <input type="text" name="lp6" 
                            class="w-full mt-1 px-3 py-2 border border-[--gray-600] rounded-lg text-center
                            focus:ring-2 focus:ring-[#008C45] focus:border-[#008C45]
                            hover:border-[#008C45] transition-all duration-[--transition-duration]" 
                            required 
                            oninput="maskNota(this)">
                    </div>
                    <div>
                        <label class="text-sm text-[--gray-600] font-medium">Artes</label>
                    ...
                    <div>
                        <label class="text-sm text-[--gray-600] font-medium">Matemática</label>
                    ...
                    <div>
                        <label class="text-sm text-[--gray-600] font-medium">História</label>
                    ...
                    <div>
                        <label class="text-sm text-[--gray-600] font-medium">Geografia</label>
                    ...
                    <div>
                        <label class="text-sm text-[--gray-600] font-medium">Ciências</label>
                    ...
                    <div>
                        <label class="text-sm text-[--gray-600] font-medium">Inglês</label>
                    ...
                    <div>
                        <label class="text-sm text-[--gray-600] font-medium">Ed. Física</label>
                        <input type="text" name="ef6" 
                            class="w-full mt-1 px-3 py-2 border border-[--gray-600] rounded-lg text-center
                            focus:ring-2 focus:ring-[#008C45] focus:border-[#008C45]
                            hover:border-[#008C45] transition-all duration-[--transition-duration]" 
                            required 
        ...
        <!-- 7º Ano -->
        <div class="bg-white p-6 rounded-xl shadow-[--shadow-sm] hover:shadow-[--shadow-md] transition-all duration-[--transition-duration]">
            <h3 class="text-lg font-semibold text-[#008C45] mb-4 pb-2 border-b border-[--gray-600]">7º Ano</h3>
            <div class="grid grid-cols-10 gap-4">
                <div class="col-span-1"></div>
                <div class="col-span-8 grid grid-cols-8 gap-4">
                    <div>
                        <label class="text-sm text-[--gray-600] font-medium">Português</label>
                        <input type="text" name="lp7" 
                            class="w-full mt-1 px-3 py-2 border border-[--gray-600] rounded-lg text-center
                            focus:ring-2 focus:ring-[#008C45] focus:border-[#008C45]
                            hover:border-[#008C45] transition-all duration-[--transition-duration]" 
                            oninput="maskNota(this)">
        ...
        <!-- 8º Ano -->
        <div class="bg-white p-6 rounded-xl shadow-[--shadow-sm] hover:shadow-[--shadow-md] transition-all duration-[--transition-duration]">
            <h3 class="text-lg font-semibold text-[#008C45] mb-4 pb-2 border-b border-[--gray-600]">8º Ano</h3>
            <div class="grid grid-cols-10 gap-4">
                <div class="col-span-1"></div>
                <div class="col-span-8 grid grid-cols-8 gap-4">
                    <div>
                        <label class="text-sm text-[--gray-600] font-medium">Português</label>
                        <input type="text" name="lp8" 
                            class="w-full mt-1 px-3 py-2 border border-[--gray-600] rounded-lg text-center
                            focus:ring-2 focus:ring-[#008C45] focus:border-[#008C45]
                            hover:border-[#008C45] transition-all duration-[--transition-duration]" 
                            oninput="maskNota(this)">
        ...
        <!-- 9º Ano -->
        <div class="bg-white p-6 rounded-xl shadow-[--shadow-sm] hover:shadow-[--shadow-md] transition-all duration-[--transition-duration]">
            <h3 class="text-lg font-semibold text-[#008C45] mb-4 pb-2 border-b border-[--gray-600]">9º Ano</h3>
            <div class="grid grid-cols-10 gap-4">
                <div class="col-span-1"></div>
                <div class="col-span-8 grid grid-cols-8 gap-4">
                    <div>
                        <label class="text-sm text-[--gray-600] font-medium">Português</label>
                        <input type="text" name="lp9" 
                            class="w-full mt-1 px-3 py-2 border border-[--gray-600] rounded-lg text-center
                            focus:ring-2 focus:ring-[#008C45] focus:border-[#008C45]
                            hover:border-[#008C45] transition-all duration-[--transition-duration]" 
                            oninput="maskNota(this)">
...
<!-- Botões de ação -->
<div class="flex justify-center space-x-4 mt-6 pt-4 border-t border-[--gray-600]">
    <button type="button" 
        onclick="closeModal()" 
        class="px-6 py-2 border border-[--gray-600] rounded-lg text-[--gray-600] 
        hover:bg-gray-50 transition-all duration-[--transition-duration] flex items-center
    ...
    <button type="submit" 
        class="px-6 py-2 bg-[#008C45] text-white rounded-lg hover:bg-[#004d00] 
        transition-all duration-[--transition-duration] flex items-center
        hover:scale-[--hover-scale] shadow-[--shadow-sm] hover:shadow-[--shadow-md]">
        <svg class="w-4 h-4 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M5 13l4 4L19 7"/>
        </svg>
        Cadastrar
