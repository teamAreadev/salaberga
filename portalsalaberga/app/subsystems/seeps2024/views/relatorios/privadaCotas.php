...
function privadaCotas($curso)
{
    ...
    $stmtSelect = $conexao->prepare("
        ...
        FROM candidato 
        INNER JOIN nota ON nota.candidato_id_candidato = candidato.id_candidato AND candidato.publica = 0 and candidato.bairro = 1 AND candidato.pcd = 0 AND candidato.id_curso1_fk = :curso
    ...
    $pdf->Cell(185, 10, ('PRIVADA COTA'), 0, 1, 'C');
