                              ...
                              <div class="dropdown">
                                <a class="dropdown-item dropdown-toggle" href="" aria-expanded="false" data-toggle="dropdown-submenu">
                                  ...
                                  <div class="dropdown-menu dropdown-submenu">
                                    <a class="dropdown-item" href="relatorios/relatorio1.php?p=1">
                                      PÚBLICA
                                    </a>
                                    <a class="dropdown-item" href="relatorios/relatorio1.php?p=0">
                                      PRIVADA
                                    </a>
                                  </div>
                                </div>
                          ...
                          <div class="dropdown-menu">
                              <div class="dropdown">
                                <a class="dropdown-item dropdown-toggle" href="" aria-expanded="false" data-toggle="dropdown-submenu">
                                  ...
                                  <div class="dropdown-menu dropdown-submenu">
                                    <a class="dropdown-item" href="relatorios/relatorio3.php?c=1">
                                      ENFERMAGEM
                                    </a>
                                    <a class="dropdown-item" href="relatorios/relatorio5.php?c=2">
                                      INFORMÁTICA
                                    </a>
                                    <a class="dropdown-item" href="relatorios/relatorio3.php?c=3">
                                      MEIO AMBIENTE
                                    </a>
                                    <a class="dropdown-item" href="relatorios/relatorio6.php?c=4">
                                      EDIFICAÇÕES
                                    </a>
                                  </div>
                                </div>
                ...
                <div class="form-group">
                  <div class="modal-header" id="modal-header2">
                      <div class="col-xs-12 text-xs-center">
                       <h3 class="mbr-section-title display-1">SEEPS 2018</h3>
                      </div>
                       <CENTER><h6 class="mbr-section-title display-4">ESCOLA PÚBLICA</h6><CENTER>
                ...
                <div class="form-group">
                  <div class="modal-header" id="modal-header2">
                      <div class="col-xs-12 text-xs-center">
                       ...
                       <CENTER><h6 class="mbr-section-title display-4">ESCOLA PRIVADA</h6></CENTER>
