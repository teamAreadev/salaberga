...
<meta name="apple-mobile-web-app-capable" content="yes">
 ...
 <script src="https://cdn.tailwindcss.com"></script>
   ...
   <link rel="icon" type="image/png" href="../seeps2024/assets/images/logo.png">
</head>
<script>
  tailwind.config = {
    theme: {
    ...
    <nav class="nav-container">
      <div class="nav-content">
        <div class="logo-container">
          <img src="https://i.postimg.cc/05hkk8xc/LOGO-new.png" alt="Logo EEEP" class="logo-img w-52 h-auto"> <!-- Aumenta o tamanho da logo -->
        </div>
  ...
  <main class="flex-grow py-16 px-4 mt-20 font-poppins">
    <section class="max-w-7xl mx-auto">
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
            ...
            ?>
                <div class="course-card relative overflow-hidden bg-white rounded-lg shadow-lg cursor-pointer group md:hover:cursor-pointer" onclick="toggleCard(this)">
                    <div class="p-6 text-center front">
                        <i class="fas <?php echo $curso['icone']; ?> text-4xl text-ceara-green mb-4"></i>
                        <h3 class="text-4xl font-bold mb-4" style="font-size: 22px"><?php echo $curso['nome']; ?></h3>
                    </div>
                    <div class="absolute inset-0 bg-white transform translate-y-full md:group-hover:translate-y-0 transition-transform duration-300 ease-in-out back">
                        <div class="text-center p-4 md:p-6">
                            <i class="fas <?php echo $curso['icone']; ?> text-3xl md:text-4xl text-ceara-green mb-3 md:mb-4"></i>
                            <h3 class="text-xl md:text-2xl font-bold mb-3 md:mb-4"><?php echo $curso['nome']; ?></h3>

                            <div class="flex flex-col items-center text-sm text-gray-700 mb-4 font-semibold">
                                <div class="flex flex-col items-start gap-3 md:gap-4 w-full px-2 md:px-4">
                                    <div class="flex items-center w-full">
                                        <i class="fas fa-users mr-3 text-ceara-green"></i>
                                        <span class="text-sm md:text-base">Total Inscritos: <?php echo $dados['total'] ?? 0; ?></span>
                                    </div>
                                    <div class="flex items-center w-full">
                                        <i class="fas fa-users mr-3 text-ceara-green"></i>
                                        <span class="text-sm md:text-base">Cota Bairro Pública: <?php echo $dados['bairro_publica'] ?? 0; ?></span>
                                    </div>
                                    <div class="flex items-center w-full">
                                        <i class="fas fa-users mr-3 text-ceara-green"></i>
                                        <span class="text-sm md:text-base">Cota Bairro Privada: <?php echo $dados['bairro_privada'] ?? 0; ?></span>
                                    </div>
                                    <div class="flex items-center w-full">
                                        <i class="fas fa-users mr-3 text-ceara-green"></i>
                                        <span class="text-sm md:text-base">Cota Escola Pública: <?php echo $dados['publica'] ?? 0; ?></span>
                                    </div>
                                    <div class="flex items-center w-full">
                                        <i class="fas fa-wheelchair mr-3 text-ceara-green"></i>
                                        <span class="text-sm md:text-base">PCD: <?php echo $dados['pcd'] ?? 0; ?></span>
                                    </div>
                                </div>
                            </div>
                        </div>
...
<style>
.course-card {
    height: 310px !important; /* Força altura fixa */
    transition: transform 0.3s ease;

}

.back {
    height: 420px !important; /* Mesma altura do card */
    transition: transform 0.3s ease;
}
...
@media (max-width: 768px) {
    .course-card,
    .back {
        height: 300px !important; /* Altura fixa para mobile */
    }
}
</style>
